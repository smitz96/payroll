...
class SalaryRecord(db.Model):
    ...
    leave_encashment_days = db.Column(db.Numeric(8, 1), nullable=False, default=Decimal("0"))
...
class LeaveLedger(db.Model):
    ...
    amount = db.Column(db.Numeric(8, 1), nullable=False)
...
class PayrollResult(db.Model):
    ...
    full_days = db.Column(db.Numeric(8, 1), default=0)
    half_days = db.Column(db.Numeric(8, 1), default=0)
    paid_working_days = db.Column(db.Numeric(8, 1), default=0)
    week_offs = db.Column(db.Integer, default=0)
    holidays = db.Column(db.Integer, default=0)
    paid_leaves = db.Column(db.Numeric(8, 1), default=0)
    lop_days = db.Column(db.Numeric(8, 1), default=0)
    opening_leave = db.Column(db.Numeric(8, 1), default=0)
    leave_earned = db.Column(db.Numeric(8, 1), default=0)
    leave_used = db.Column(db.Numeric(8, 1), default=0)
    closing_leave = db.Column(db.Numeric(8, 1), default=0)
